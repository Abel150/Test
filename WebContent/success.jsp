...
<div class="searchbox">
 ...
 <div class="gouwuche">
    ...
    <img src="images/cart.jpg" width="45" height="45"></a>
    <a href="order.jsp"  target="_blank">
    <br />
    <br />
    <br />
    <img src="images/dingdan.png" width="45" height="45"></a>
    </div>
 ...
 <div class="promotion">
   ...
   <div class="selloperate">
    ...
    <br />
     ...
     Hello,&nbsp;<c:out value='${sessionScope.user}' default='guest'/>
                <br />
                <br />
